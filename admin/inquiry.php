...
<body>
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container">
                    ...
                    <div class="nav-options">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="../admin/inquiry.php"><b>Inquiry</b></a></li>
    ...
    <div>
        <div>
            <p style="padding-left: 80px; padding-top: 50px; font-size: larger;"><b>Inquiries List -</b></p>
        </div>
        ...
        <div style="padding-left: 120px; margin-top: 2%;">
            <table>
                ...
                <?php
                    if (mysqli_num_rows($inq_result) == 0) {
                        ?><strong>
                            <?php echo htmlentities("No Packages to show!"); ?>
                        </strong>
                        <?php
                    } else {
                        while ($inq_row = mysqli_fetch_assoc($inq_result)) {
                            $count++;
                            ?>
                <tr>
                    <td><?php echo htmlentities($count); ?></td>
                    <td><?php echo htmlentities(date('d/m/Y', strtotime($inq_row['inq_date']))); ?></td>
                    <td><?php echo htmlentities($inq_row['inq_time']); ?></td>
                    <td><?php echo htmlentities($inq_row['inq_email']); ?></td>
                    <td><?php echo htmlentities($inq_row['inq_msg']); ?></td>
                    <td>
                        <button style="background-color: red;"><a href="delete_inquiry.php?inqId=<?php echo htmlentities($inq_row['inq_id']); ?>" style="color: white; text-decoration: none;"><i class="fa-solid fa-trash"></i></a></button>
                    </td>
                </tr>
                <?php
                        }
    ...
    <div id="editModal" class="edit-modal">
        <div class="edit-modal-content" style="height: 500px; width: 580px;">
            <p style="color: white; font-size: medium; padding-left: 10px;"><b>View Inquiries</b><span class="edit-close" onclick="closeEditModal()">&times;</span></p><hr style="background-color: white;">

            <div class="bk-modal-body" style="width: 500px; color: white; padding-left: 10px;">
                <label for="username"><b>Inquirer's Name:</b></label>
                <input type="text" class="form-control" id="date" style="width: 530px;">

                <label for="username"><b>Inquirer's Email:</b></label>
                <input type="text" class="form-control" id="date" style="width: 530px;">

                <label for="username"><b>Subject</b></label>
                <input type="text" class="form-control" id="number" style="width: 530px;">

                <label for="username"><b>Message:</b></label>
