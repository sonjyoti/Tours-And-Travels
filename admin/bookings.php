...
<body>
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container">
                    ...
                    <div class="nav-options">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="../admin/bookings.php"><b>Bookings</b></a></li>
    ...
    <div>
        <div>
            <p style="padding-left: 80px; padding-top: 50px; font-size: larger;"><b>Bookings List -</b></p>
        </div>
        ...
        <div style="padding-left: 120px; margin-top: 2%;">
            <table>
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($book_row['book_days']); ?></td>
                    <td><?php echo htmlentities($book_row['book_person']); ?></td>
                    <td><?php echo htmlentities($book_row['book_status']); ?></td>

                    <td>
                        <?php 
                            if ($book_row['book_status'] == 'Pending' || $book_row['book_status'] == 'Confirmed') {
                        ?>
                        <button style="background-color: green;"><a href="booking_status.php?bookId=<?php echo htmlentities($book_row['book_id']); ?>" style="color: white; text-decoration: none;"><i class="fa-solid fa-eye"></i></a></button>
                        <?php 
                        }
                        ?>
                        <button style="background-color: red;"><a href="delete_booking.php?bookId=<?php echo htmlentities($book_row['book_id']); ?>" style="color: white; text-decoration: none;"><i class="fa-solid fa-trash"></i></a></button>
                    </td>
                </tr>
                <?php
                        }
    ...
    <div id="editModal" class="edit-modal">
        <div class="edit-modal-content" style="height: 510px; width: 580px;">
            <p style="color: white; font-size: medium; padding-left: 10px;"><b>View Status</b><span class="edit-close" onclick="closeEditModal()">&times;</span></p><hr style="background-color: white;">

            <div class="bk-modal-body" style="width: 500px; color: white; padding-left: 10px;">
                <label for="username"><b>Package Title:</b></label>
                <input type="text" class="form-control" id="date" style="width: 530px;">

                <label for="username"><b>Book Date:</b></label>
                ...
                <select class="form-control" style="width: 530px;">
                ...
                <div style="padding-top: 10px; padding-bottom: 10px;">
                    <button type="update" style="background-color: green; color: white; height: 40px; width: 530px;"><b>Update</b></button>
                </div>
            </div>
        </div>
    </div>
